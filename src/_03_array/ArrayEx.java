...
public class ArrayEx {
    public static void main(String[] args) {
        ...
        // - 배열 변수 "참조 변수"(배열도 객체!)
        // 배열 변수는 힘 영역의 배열 주소를 저장.
        // 따라서 참조할 수 없다면 null로 초기화 가능
        // ex) 타입[] 변수 = null;
        String[] temp = null;
        System.out.println("temp = " + temp);

        // - "값 목록"으로 배열 변수 선언과 생성
        // : 중괄호는 나열된 값들을 항목으로 갖는 배열을 힙에 생성하고, "번지"를 리턴
        // 즉, 배열 변수는 "리턴된 번지"를 저장함으로 참조가 이루어짐
        ...
        // - "new 연산자"로 배열 선언과 생성
        // : new 연산자로 배열 처음 생성 시, 배열 항목은 기본 값으로 초기화
        ...
        // 배열 복사
        // - 배열은 크기가 고정되어 있음
        // -> 더 많은 저장공간이 필요해지면 더 큰길이의 배열을 새로 만들어서 기존 배열 복사 필요
        ...
        // 복제 전
        System.out.println("Array.toString(originFruits) = " + Arrays.toString(originFruits));
        ...
        // copyOfRange(arr, sIdx, eIdx): 배열 시작 인덱스와 끝 인덱스를 지정해, 복사한 새로운 반환
        ...
        // deepEquals(arr1, arr2): 단일 차원/ 다차원 두 배열이 같은지 비교
